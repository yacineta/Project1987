...
const CreatCategory = () => {
    ...
    const handleSubmit = async (e) =>{
        ...
        try{
            ...
            console.log(error)
            toast.error('Somthing went wrong in input')
        }
    };
    ...
    const getAllCategory = async () => {
        try{
            ...
            console.log(error,'Erorre in you Category');
            toast.error('Error In Gaiting Data')
        }
    };
  ...
  return (
    ...
    <Layout titele={"Dashboard-Creat-Category"}>
